...
<body>
	<form id='frminscricao' name='frminscricao' action='administracao/questionario/questionario.php' method='post' onsubmit='return validar()' >
		<p><strong>Questionario Socioeconomico</strong></p>
